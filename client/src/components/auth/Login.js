        ...
        <Fragment>
            ...
            <form class='form' onSubmit={e => onSubmit(e)}>
                <div class='form-group'>
                    <input type='email' placeholder='Email adress' name='email' required value={email} onChange={e => onChange(e)} />
                </div>
                <div class='form-group'>
            ...
            <p class="my-1">
                Ещё нет аккаунта?<Link to="/register"> Зарегестрируйтесь</Link>
            </p>
        </Fragment>
    )
}
